        ...
        t && t.addEventListener("click", () => {
            {
                ...
                a.innerHTML = [`<div class="alert alert-${t} alert-dismissible" role="alert">`, `   <div>${e}</div>`, '   <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>', "</div>"].join(""), n.append(a)
            }
        })
    }
    initPortletCard() {
...
class ThemeCustomizer {
    ...
    initTwoColumn() {
        var a, n, t, i, o;
        $("#two-col-sidenav-main").length && (a = $("#two-col-sidenav-main .side-nav-link"), n = $(".sidenav-menu-item"), t = $(".sidenav-menu-item .sub-menu"), (i = $("#two-col-menu menu-item .collapse")).on({
    ...
    initSwitchListener() {
        var a = this,
            ...
            e = (e && e.addEventListener("click", function() {
                ...
                "full" === t ? a.showBackdrop() : "fullscreen" == e ? "fullscreen" === t ? a.changeLeftbarSize("fullscreen" == e ? "default" : e, !1) : a.changeLeftbarSize("fullscreen", !1) : "condensed" === t ? a.changeLeftbarSize("condensed" == e ? "default" : e, !1) : a.changeLeftbarSize("condensed", !1), a.html.classList.toggle("sidebar-enable")
    ...
    _adjustLayout() {
        var e = this;
        window.innerWidth <= 1140 ? (e.changeLeftbarSize("full", !1), e.changeLayoutMode("default", !1)) : (e.changeLeftbarSize(e.config.sidenav.size), e.changeLayoutMode(e.config.layout.mode))
    }
    setSwitchFromConfig() {
        sessionStorage.setItem("__HIGHDMIN_CONFIG__", JSON.stringify(this.config)), document.querySelectorAll(".right-bar input[type=checkbox]").forEach(function(e) {
            e.checked = !1
        });
